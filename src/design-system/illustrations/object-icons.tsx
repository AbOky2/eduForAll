...
function Goat({ size }: { size: number }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 48 48">
      ...
      <Path d="M38 14c2-2 2-4 1-6M33 14c-1-2-1-4 0-6" stroke={BROWN} strokeWidth={1.6} strokeLinecap="round" fill="none" />
      <Circle cx={37} cy={19} r={1.2} fill={INK} />
      <Path d="M35 25c0 2 1 3 2 3" stroke={INK} strokeWidth={1.2} strokeLinecap="round" fill="none" />
      <Path d="M14 35v6M20 36v5M28 36v5M33 35v6" stroke={INK} strokeWidth={1.8} strokeLinecap="round" />
      <Path d="M12 27c-2 0-3 1-3 3" stroke={INK} strokeWidth={1.4} strokeLinecap="round" fill="none" />
    </Svg>
  );
}
...
function Mango({ size }: { size: number }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 48 48">
      <Path d="M14 20c4-8 16-9 21-3 5 7 1 19-8 21C17 40 10 31 14 20z" fill={GOLD} stroke={RED} strokeWidth={1.6} />
      <Path d="M30 12c1-3 4-4 6-4-1 3-3 5-6 4z" fill={GREEN} />
      <Path d="M18 22c-1 4 0 8 3 11" stroke="#e8a23d" strokeWidth={1.8} strokeLinecap="round" fill="none" />
    </Svg>
  );
}
...
function Hut({ size }: { size: number }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 48 48">
      ...
      <Rect x={12} y={26} width={24} height={14} rx={2} fill={SAND} stroke={INK} strokeWidth={1.2} />
...
function Calabash({ size }: { size: number }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 48 48">
      <Path d="M24 10c-2 5-10 6-10 15 0 8 5 13 10 13s10-5 10-13c0-9-8-10-10-15z" fill={SAND} stroke={BROWN} strokeWidth={1.6} />
      <Ellipse cx={24} cy={26} rx={6} ry={7} fill="none" stroke={BROWN} strokeWidth={1.2} opacity={0.5} />
    </Svg>
  );
}
...
function Moto({ size }: { size: number }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 48 48">
      ...
      <Path d="M12 34l7-13h9l6 9" stroke={BLUE} strokeWidth={2.6} strokeLinecap="round" fill="none" />
...
function Bed({ size }: { size: number }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 48 48">
      <Path d="M8 16v22M8 30h32v8" stroke={BROWN} strokeWidth={2.4} strokeLinecap="round" fill="none" />
      <Rect x={11} y={22} width={10} height={7} rx={3} fill={CREAM} stroke={INK} strokeWidth={1.2} />
...
function Cat({ size }: { size: number }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 48 48">
      ...
      <Path d="M14 18l-2-8 8 4zM34 18l2-8-8 4z" fill="#b98a5a" stroke={INK} strokeWidth={1.4} strokeLinejoin="round" />
      <Circle cx={19.5} cy={24} r={1.6} fill={INK} />
      <Circle cx={28.5} cy={24} r={1.6} fill={INK} />
      <Path d="M21 30c2 1.6 4 1.6 6 0" stroke={INK} strokeWidth={1.6} strokeLinecap="round" fill="none" />
      <Path d="M10 27h-5M11 30l-4 2M38 27h5M37 30l4 2" stroke={INK} strokeWidth={1.2} strokeLinecap="round" />
    </Svg>
  );
}
...
function Sheep({ size }: { size: number }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 48 48">
      ...
      <Path d="M9 16c-1-2 0-4 2-4M15 16c1-2 0-4-2-4" stroke={INK} strokeWidth={1.3} strokeLinecap="round" fill="none" />
      <Path d="M18 35v6M24 36v5M31 36v5M36 34v7" stroke={INK} strokeWidth={1.8} strokeLinecap="round" />
    </Svg>
  );
}
...
function Soap({ size }: { size: number }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 48 48">
      <Rect x={9} y={20} width={30} height={17} rx={6} fill={BLUE} stroke="#1c4a63" strokeWidth={1.4} />
      ...
      <Path d="M15 27c3-2 15-2 18 0" stroke="#a3d8fe" strokeWidth={2} strokeLinecap="round" fill="none" />
    </Svg>
  );
}
...
function King({ size }: { size: number }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 48 48">
      ...
      <Path d="M14 14l3-7 4 4 3-6 3 6 4-4 3 7z" fill={GOLD} stroke="#d99a00" strokeWidth={1.2} strokeLinejoin="round" />
      <Circle cx={21} cy={21} r={1.5} fill={INK} />
      <Circle cx={27} cy={21} r={1.5} fill={INK} />
      <Path d="M21 26c2 1.4 4 1.4 6 0" stroke={INK} strokeWidth={1.4} strokeLinecap="round" fill="none" />
    </Svg>
  );
}
...
function Wolf({ size }: { size: number }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 48 48">
      <Path d="M24 40c-8 0-13-6-13-13 0-3 1-6 3-8l-2-9 8 5c1.2-.4 2.6-.6 4-.6s2.8.2 4 .6l8-5-2 9c2 2 3 5 3 8 0 7-5 13-13 13z" fill="#7a7f92" stroke={INK} strokeWidth={1.4} />
