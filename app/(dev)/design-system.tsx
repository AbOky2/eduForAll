...
const ICONS: IconName[] = [
  'speaker', 'play', 'check', 'close', 'star', 'star-outline', 'lock', 'lightbulb',
  'arrow-back', 'chevron-right', 'gear', 'home', 'book', 'pencil', 'ear',
  'calculator', 'parents', 'cloud-off', 'pause', 'replay', 'leaf', 'sparkle', 'trash', 'share',
];

const OBJECT_ICONS = [
  'icon-goat', 'icon-mango', 'icon-hut', 'icon-star', 'icon-calabash', 'icon-moto',
  'icon-bed', 'icon-tomato', 'icon-salad', 'icon-father', 'icon-friends', 'icon-cat',
  'icon-sheep', 'icon-soap', 'icon-king', 'icon-wolf', 'icon-wood', 'icon-missing-example',
];
...
const styles = StyleSheet.create({
  ...
  swatch: { width: 48, height: 48, borderRadius: 12, borderWidth: 1, borderColor: colors.outlineVariant },
