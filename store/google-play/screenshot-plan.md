# Plan de captures Google Play (brouillon)
...
Identique à `store/app-store/screenshot-plan.md` (9 plans, profil fictif
« Amina », CP1).
...
|---|---|---|
| Téléphone | 16:9 ou 9:16, côté 320–3840 px | 2 min, 8 max |
| Tablette 7" | idem | 8 max — nécessaire pour la fiche tablette |
| Tablette 10" | idem | 8 max — nécessaire pour la fiche tablette |
